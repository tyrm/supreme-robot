...
func (c *Scheduler) AddDomain(id uuid.UUID) error {
...
func (c *Scheduler) RemoveDomain(id uuid.UUID) error {
...
func (c *Scheduler) UpdateSubDomain(id uuid.UUID, name string) error {
